<%@ Page Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true"
    CodeFile="NovoCadastro.aspx.cs" Inherits="NovoCadastro" Title="MetodologiasAgeis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="w3-container w3-justify w3-content" style="max-width: 600px">
        ...
        <table>
            ...
            <tr>
                <td>
                    <asp:Button ID="btnSalvar" runat="server" Text="Salvar" OnClick="btnSalvar_Click" class="w3-btn"/>
